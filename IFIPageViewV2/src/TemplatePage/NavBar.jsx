          ...
          <div className="left_col scroll-view">
            ...
            <div className="profile clearfix">
              <div className="profile_pic">
                <img src="http://www.ifisolution.com/wp-content/themes/steel/images/favicon.png" alt="..." className="img-circle profile_img img-responsive"/>
              </div>
              ...
              <div className="menu_section">
                <h3>Menu</h3>
                    ...
                    <ul className="nav side-menu">
                        ...
                        <li><a><i className="fa fa-user"></i>Allocation<span className="fa fa-chevron-down"></span></a>
                            <ul className="nav child_menu">
                                <li><Link to="/pages/employee">Employee Manager</Link></li>
                                <li><Link to="/pages/project">Project Manager</Link></li>
                                <li><Link to="/pages/statistics">Statistics</Link></li>
                            </ul>
                        </li>
                    </ul>
